    ...
    case WM_PAINT:
        ...
        case 1:
            ...
            for (int i = 0; i < MONSTEROFNUMBER - 2; i++) { 
                DrawMonster(memDC, monster[i], ms);
            }
        ...
        case 2:
            ...
            for (int i = 0; i < MONSTEROFNUMBER; i++) { 
                DrawMonster(memDC, monster[i], ms2);
            }
            heroH.DrawHero(memDC, hero);
            objectH.DrawObjectDOWN(memDC, object, os, hero);
            objectH.DrawItem(memDC, item, items);
        ...
        case 3:
            ...
            DrawBossSkill3(memDC, snowBoss, bs);
            DrawBoss(memDC, snowBoss, bs);
            DrawBossSkill2(memDC, snowBoss, bs);
            DrawBossSkill4(memDC, snowBoss, bs);
            heroH.DrawHero(memDC, hero);
            DrawBossSkill1(memDC, snowBoss, bs);
...
void DrawMonster(HDC hDC, MONSTER monster, MONSPRITE ms)
{
...
void DrawBossSkill4(HDC hDC, BOSS snowBoss, BOSSSPRITE bs) { //스킬4
    HDC tempDC = CreateCompatibleDC(hDC);
    for (int i = 0; i < BOSS_MONSTER_MAX; i++) {
...
void DrawBossSkill3(HDC hDC, BOSS snowBoss, BOSSSPRITE bs) {//스킬3
    HDC tempDC = CreateCompatibleDC(hDC);
    if (snowBoss.skill3.skill3Toggle == 1) {
...
void DrawBossSkill1(HDC memDC, BOSS snowBoss, BOSSSPRITE bs)
{
