...
//#include "Sprite.h"
//
//void Boss::DrawBoss(HDC hDC, Sprite bs)
//{
...
//    DeleteObject(tempDC);
//}
//void Boss::DrawBossSkill4(HDC hDC, Sprite bs) { //스킬4
//    HDC tempDC = CreateCompatibleDC(hDC);
...
//                    TransparentBlt(hDC, skill4.mon[i].X, skill4.mon[i].Y, 100, 100, tempDC, skill4.mon[i].monSpriteCount * 150, 0, 150, 100, RGB(255, 255, 255));
//                }
//                if (skill4.mon[i].direction == RIGHT) {
//                    TransparentBlt(hDC, skill4.mon[i].X, skill4.mon[i].Y, 100, 100, tempDC, skill4.mon[i].monSpriteCount * 150, 100, 150, 100, RGB(255, 255, 255));
//                }
//                if (skill4.mon[i].direction == DOWN) {
//                    TransparentBlt(hDC, skill4.mon[i].X, skill4.mon[i].Y, 100, 100, tempDC, skill4.mon[i].monSpriteCount * 150, 200, 150, 100, RGB(255, 255, 255));
//                }
//                if (skill4.mon[i].direction == UP) {
//                    TransparentBlt(hDC, skill4.mon[i].X, skill4.mon[i].Y, 100, 100, tempDC, skill4.mon[i].monSpriteCount * 150, 300, 150, 100, RGB(255, 255, 255));
//                }
//
//            }
//            else {
//                SelectObject(tempDC, bs.skill4Egg);
//                TransparentBlt(hDC, skill4.mon[i].X, skill4.mon[i].Y, 100, 100, tempDC, skill4.mon[i].eggSpriteCount * 100, 0, 100, 100, RGB(0, 0, 0));
//            }
//        }
//        else if (skill4.mon[i].status == 2) {
//            SelectObject(tempDC, bs.skill4Monster);
//            TransparentBlt(hDC, skill4.mon[i].X, skill4.mon[i].Y, 100, 100, tempDC, 0, 400, 150, 100, RGB(255, 255, 255));
//        }
//
//    }
//    DeleteObject(tempDC);
//}
//void Boss::DrawBossSkill3(HDC hDC, Sprite bs) {//스킬3
//    HDC tempDC = CreateCompatibleDC(hDC);
...
//    DeleteObject(tempDC);
//}
//void Boss::DrawBossSkill2(HDC hDC, Sprite bs)
//{
//    HDC tempDC = CreateCompatibleDC(hDC);
...
//    DeleteObject(tempDC);
//}
//void Boss::DrawBossSkill1(HDC memDC, Sprite bs)
//{
...
//                    skill4.mon[i].X = (rand() % (MAP_ROW - 200)) + 100;
//                    skill4.mon[i].Y = (rand() % (MAP_COL - 300)) + 250;
//                    skill4.mon[i].life = 1;
...
//                    }
//                    //벽 충돌시 방향 전환
//                    if (skill4.mon[i].X < 0) skill4.mon[i].direction = RIGHT;
//                    else if (skill4.mon[i].X + 100 > MAP_ROW) skill4.mon[i].direction = LEFT;
//                    else if (skill4.mon[i].Y < 135) skill4.mon[i].direction = DOWN; //보스 아래로만 움직임
//                    else if (skill4.mon[i].Y + 100 > MAP_COL) skill4.mon[i].direction = UP;
//                    //랜덤 방향 전환
